...
/**
 * Created by madga_000 on 12/12/2015.
 */
public class Activity_CSE extends AppCompatActivity {
    ...
    public class MyListAdapter extends ArrayAdapter<Students>{
        public MyListAdapter(){
            super(Activity_CSE.this, R.layout.activity_layout, students);
        }
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            cb.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    final Intent intent = new Intent(Activity_CSE.this, AcitivityAbsentees.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == 0) {
            Intent i=new Intent(Activity_CSE.this,studentDetails.class);
            startActivity(i);
        }
        if (id == 1){
            Intent i1=new Intent(Activity_CSE.this,DeleteStudent.class);
            startActivity(i1);

        }
        if (id==2){
            Intent i2=new Intent(Activity_CSE.this,EditDetails.class);
            startActivity(i2);
